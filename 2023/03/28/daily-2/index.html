...
<html lang="en">
    ...
    <div class="info">
        ...
        <span class="tags">
            ...
            <span class="tag">
                ...
                <a href="/tags/daily/" style="color: #03a9f4">daily</a>
            </span>
    ...
    <div class="content" v-pre>
        <p>CF 455A</p>
<p>常规DP，首先不要从n来想，一般针对于这个值的大小的转移方程多去值来想，因为这里是1e5，肯定可以去从值来想的</p>
<p>转移方程很简单</p>
<p>$dp[i]=max(dp[i-1],dp[i-2]+cnt[i]*i)$</p>
...
<p>CF 455B</p>
<p>博弈+dp</p>
<p>先计算出当前有必败策略和必胜策略的节点，然后我们对于同时拥有必败和必胜策略的根节点，那么肯定是先手赢（随意控制）</p>
<p>如果根节点只有必胜策略，那么就是交替赢，算k的奇偶性就好了</p>
<p>如果根节点只有必败策略，那么一定输</p>
<pre><code class="lang-C++">int tree[MAXN&lt;&lt;2][26];
int is_leaf[MAXN&lt;&lt;2];
int cnt;
