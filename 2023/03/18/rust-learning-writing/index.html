...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>rust learning writing | Waiting for the dawn</title>
    ...
    <div class="content" v-pre>
        <ol>
<li>PartialEq PartialOrd trait</li>
</ol>
<p>让你可以自由地定义=和不=<br>让你可以自由地定义&gt;和&lt;</p>
<ol>
<li>一个标准的单元测试应该这样写<pre><code class="lang-Rust">#[cfg(test)]
pub mod test&#123;
